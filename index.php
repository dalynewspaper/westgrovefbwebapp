...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Welcome to the Westgrove Hotel</title>
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            <li><span>Image 01</span><div><h3>Hello and Welcome </h3></div></li>
            <li><span>Image 02</span><div><h3>Wedding receptions</h3></div></li>
            <li><span>Image 03</span><div><h3>Luxurious Sleepovers</h3></div></li>
            <li><span>Image 04</span><div><h3>Weddings to remember</h3></div></li>
            <li><span>Image 05</span><div><h3>Find a better gym</h3></div></li>
            <li><span>Image 06</span><div><h3>elegant dining </h3></div></li>
